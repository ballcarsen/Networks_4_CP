...
if __name__ == '__main__':
    ...
    link_layer.add_link(link_2.Link(host_2, 0, router_b, 0))
    link_layer.add_link(link_2.Link(router_b, 1, router_a, 0))
    link_layer.add_link(link_2.Link(router_a, 1, host_1, 0))
